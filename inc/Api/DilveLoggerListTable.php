...
class DilveLoggerListTable extends WP_List_Table {
    ...
    public function __construct() {
        parent::__construct([
            'singular' => 'dilve_logger',  // Singular label of the table
            'plural'   => 'dilve_loggers', // Plural label of the table
    ...
    public function prepare_items() {
        global $wpdb;
        $dilveApiDbLoggerManager = new DilveApiDbLoggerManager;
        $loggerTable = $wpdb->prefix . $dilveApiDbLoggerManager::DILVE_LOGGER_TABLE;
    ...
    public function wp_list_table_data($where = '', $per_page = 20,  $orderby = '', $order = '', $search_term = '') {
        ...
        $loggerTable = $wpdb->prefix . $dilveApiDbManager::DILVE_LOGGER_TABLE;
